...
import Hero from "../components/MosesLake/Hero";
import About from "../components/MosesLake/About";
import Guilds from "../components/MosesLake/Guilds";
import Steps from "../components/MosesLake/Steps";
import Locations from "../components/MosesLake/Locations";
import Faq from "../components/MosesLake/Faq";
import Footer from "../components/MosesLake/Footer";

// TODO: Change `ExampleCity` to the name of your city
export default function MosesLake() {
  ...
  return (
    <>
      <Head>
        ...
        <title>Counterspell Moses Lake</title>
      </Head>
      <div>
        <div
        ...
        <a
          ...
          className="text-white fixed top-4 right-4 retro bg-pink py-2 px-3 lg:py-3 lg:px-4 uppercase z-50 hover:scale-105 hover:text-white no-underline md:text-[1.5rem] lg:text-[1.7rem] rounded-full"
