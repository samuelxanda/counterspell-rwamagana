...
import Hero from "../components/Arlington/Hero";
import About from "../components/Arlington/About";
import Guilds from "../components/Arlington/Guilds";
import Steps from "../components/Arlington/Steps";
import Locations from "../components/Arlington/Locations";
import Faq from "../components/Arlington/Faq";
import Footer from "../components/Arlington/Footer";
...
export default function Arlington() {
  ...
  return (
    <>
      <Head>
        <title>Counterspell Arlington</title>
      </Head>
      <div>
        <div
          ...
          style={{ opacity: scrollPos !== 0 ? "0" : "100" }}
        ></div>
        <div
          style={{
            zIndex: 999,
