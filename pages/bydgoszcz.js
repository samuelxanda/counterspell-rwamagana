...
import Hero from "../components/Bydgoszcz/Hero";
import About from "../components/Bydgoszcz/About";
import Guilds from "../components/Bydgoszcz/Guilds";
import Steps from "../components/Bydgoszcz/Steps";
import Locations from "../components/Bydgoszcz/Locations";
import Faq from "../components/Bydgoszcz/Faq";
import Footer from "../components/Bydgoszcz/Footer";

export default function Bydgoszcz() {
  ...
  return (
    <>
      <Head>
        {}
        <title>Counterspell Bydgoszcz</title>
      </Head>
      <div>
        <div
