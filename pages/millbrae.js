...
Make a copy of the example components (components/Millbrae) and rename it for your city.
...
// TODO: Change `Millbrae` to the name of your city. This should match the folder you copied!
import Hero from "../components/Millbrae/Hero";
import About from "../components/Millbrae/About";
import Guilds from "../components/Millbrae/Guilds";
import Steps from "../components/Millbrae/Steps";
import Locations from "../components/Millbrae/Locations";
import Faq from "../components/Millbrae/Faq";
import Footer from "../components/Millbrae/Footer";

// TODO: Change `Millbrae` to the name of your city
export default function Millbrae() {
  ...
  return (
    <>
      <Head>
        ...
        <title>Counterspell Millbrae</title>
      </Head>
      <div>
        <div
