...
import Hero from "../components/Oshkosh/Hero";
import About from "../components/Oshkosh/About";
import Guilds from "../components/Oshkosh/Guilds";
import Steps from "../components/Oshkosh/Steps";
...
export default function Oshkosh() {
  ...
  return (
    <>
      <Head>
        <title>Counterspell Oshkosh</title>
      </Head>
      <div>
        <div
          ...
          style={{ opacity: Math.max(0, (docHeight - scrollPos - 1000) / docHeight) }}
        ></div>
        <div
          style={{
            zIndex: 999,
