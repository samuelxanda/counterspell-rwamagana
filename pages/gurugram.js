...
import Hero from "../components/Gurugram/Hero";
import About from "../components/Gurugram/About";
import Guilds from "../components/Gurugram/Guilds";
import Steps from "../components/Gurugram/Steps";
import Locations from "../components/Gurugram/Locations";
import Faq from "../components/Gurugram/Faq";
import Footer from "../components/Gurugram/Footer";
...
export default function Gurugram() {
  ...
  return (
    <>
      <Head>
        <title>Counterspell Gurugram</title>
      </Head>
      <div>
        <div
