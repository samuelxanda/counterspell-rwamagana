...
import Hero from "../components/ValenzuelaCity/Hero";
import About from "../components/ValenzuelaCity/About";
import Guilds from "../components/ValenzuelaCity/Guilds";
import Steps from "../components/ValenzuelaCity/Steps";
import Locations from "../components/ValenzuelaCity/Locations";
import Faq from "../components/ValenzuelaCity/Faq";
import Footer from "../components/ValenzuelaCity/Footer";

// TODO: Change `ExampleCity` to the name of your city
export default function ValenzuelaCity() {
  ...
  return (
    <>
      <Head>
        ...
        <title>Counterspell Valenzuela City</title>
      </Head>
      <div>
        <div
