        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 grid-rows-2 gap-12 leading-[3rem] tracking-wider mx-6 2xl:mx-0">
          <div className="row-span-2 p-8 space-y-12 border-4 border-dashed border-pink md:p-12">
            <p>
              ...
              Counterspell Millbrae is a beginner friendly game jam for high
              schoolers happening in Millbrae where{" "}
            ...
            <p>
              {/* TODO: Change `Millbrae` to the name of your city */}
              Any game counts! The theme for Counterspell Millbrae will be
