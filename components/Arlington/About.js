    ...
    <div className="flex justify-center neuebit text-3xl py-24">
      <div className="space-y-12 max-w-8xl">
        <h2 className="pb-6 text-4xl text-center uppercase retro text-whitepurp">
          Make games, learn to code, and <span className="text-pink">meet new friends</span>!
        </h2>
        <div className="grid grid-cols-1 xl:grid-cols-2 grid-rows-2 gap-12 leading-[3rem] tracking-wider mx-6 2xl:mx-0">
          <div className="row-span-2 p-8 space-y-12 border-4 border-dashed border-pink md:p-12">
            <p>
              Counterspell Arlington is a beginner friendly game jam for high
              schoolers happening in Arlington, TX where{" "}
            ...
            <p>
              Any game counts! The theme for Counterspell Arlington will be
              decided through peer voting before the event starts.{" "}
            </p>
            <p>
              Whether you’re a beginner or an expert, you’re welcome to join
              Counterspell Arlington. We will have <span className="text-pink">workshops</span> and
              <span className="text-pink"> mentors</span> there to help you out.
            </p>
          </div>
          <div
