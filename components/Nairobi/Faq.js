...
const faqData = [
  ...
  },
  {
    ...
    answer: `Your laptop, charger, and an open mind! And perhaps some friends :)`,
  },
  {
    ...
    >
      <div className="h-full p-5">
        <div className="flex flex-col justify-center h-full p-3 bg-black/40">
          ...
          <p className="text-xl leading-6 text-justify neuebit" dangerouslySetInnerHTML={{ __html: faqItem.answer }}></p>
        </div>
      </div>
    </div>
  );
...
export default function Faq() {
  ...
  useEffect(() => {
    ...
    const randArray = Array.from({ length: numFaq }, (_, i) => i + 1).sort(() => Math.random() - 0.5);
