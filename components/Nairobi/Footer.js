  ...
  return (
    <div className="p-6 pt-4 text-2xl bg-pink neuebit">
      ...
      <div className="flex items-center justify-center ">
        ...
        |{" "}
        <a href="https://www.youtube.com/@HackClubHQ" target="_blank" rel="noopener noreferrer" className="mx-4">
          YouTube
        </a>{" "}
        |{" "}
      ...
      <div className="text-center">
        <a href="https://www.instagram.com/aeralixe/?hl=en" target="_blank" rel="noopener noreferrer" className="mx-2">
